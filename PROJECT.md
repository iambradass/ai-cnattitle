...
- Repository: `https://github.com/iambradass/ai-cnattitle.git`.
- Release: Reviewed origin/main push to Hostinger; use deploy-ai and flush CDN. vercel.json is legacy routing, not the active hosting configuration.
- This is the static public site, separate from the team-facing internal hub. .htaccess owns production routes. Preserve hosted Vault iframe wiring and backup conventions when editing Vault sources.
